...
abstract class Rest
{
    ...
    public static function getAcceptType()
    {
        ...
        $type = [
            'html' => 'text/html,apps/xhtml+xml,*/*',
            'xml'  => 'apps/xml,text/xml,apps/x-xml',
            'json' => 'apps/json,text/x-json,apps/jsonrequest,text/json',
            'js'   => 'text/javascript,apps/javascript,apps/x-javascript',
            'css'  => 'text/css',
            'rss'  => 'apps/rss+xml',
            'yaml' => 'apps/x-yaml,text/yaml',
            'atom' => 'apps/atom+xml',
            'pdf'  => 'apps/pdf',
            'text' => 'text/plain',
            'png'  => 'image/png',
